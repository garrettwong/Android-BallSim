...
public class AccelerometerPlayActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSimulationView.setBackgroundResource(R.drawable.tablecup);
    ...
    class SimulationView extends FrameLayout implements SensorEventListener {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                Log.v("x of " + i + ":", String.valueOf(x));
                Log.v("yc of " + i + ":", String.valueOf(y));

                if (sx > 0.3 && sy > 0.3) particleSystem.mBalls[3].setIsAlive(false);

                if (particleSystem.mBalls[i].isAlive() ) {
